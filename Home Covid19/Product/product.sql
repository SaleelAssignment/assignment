...
1. Write a query to display all offices which are located other than in 'NY' state. 
2. Write a query to display all offices whose phone number starts with '+1'. 
...
14. Write a query to print all the customers to whom no employees are giving services to them.
...
14. select * from customers where salesRepEmployeeNumber is null;
